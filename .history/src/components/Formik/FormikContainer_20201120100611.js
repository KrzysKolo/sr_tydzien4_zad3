...
const FormikContainer = () => {
    ...
    const onSubmit = values => {
        alert("Dane"+values+" zostały przesłane prawidłowo");
    }
    return (
        <Formik
        ...
        >
            { ({formik, values, errors}) => (
                <Form className="form-wrapper">
                    ...
                    <FormikControl className={formik.errors.name ? 'has-error' : ''} control='input' type='text' label='Name:' name='name' placeholder="your name"/>
